...
main: 
	...
	#testing LocialOps
			...
			nor $t2, $t0, $t1  #test nor --- should output -256
			xori $t3, $t0, 500 #test xori --- should output 496
			ori $t2, $t1, $t0  #test ori --- should output -1
			...
			rotrv $t4, $t0, 4  #test rotr -- should output 	1073741824
			sra $t2, $t0, 1    #test sra -- should output 2
			sra $t2, $t4, $t0  #test srav -- should output 67108864
	...
	#testing memory access (and hazard detection)
			...
			lw $t8, 12($t0) #more testing of lw and sw should output1073741824
